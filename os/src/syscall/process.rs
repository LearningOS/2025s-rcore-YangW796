...
use crate::{
    config::PAGE_SIZE, fs::{open_file, OpenFlags}, mm::{create_new_map_area, map_vpns_to_ppns, translated_byte_buffer, translated_refmut, translated_str, unmap_vpns, MapPermission, VirtAddr}, task::{
...
pub fn sys_mmap(start: usize, len: usize, prot: usize) -> isize {
    ...
    if map_vpns_to_ppns(start_vpn, end_vpn) {return -1;}

    let entry = MapPermission::from_bits_truncate(((prot as u8) << 1) & 0b1110) | MapPermission::U;
